            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    every detail elevates your vision from ordinary to
                    extraordinary.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    While most clients strive to resolve issues with buyers, we
                    offer a refund if a satisfactory solution cannot be
                    achieved.
                  </p>
                </div>
              </div>
